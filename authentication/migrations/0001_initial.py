# Generated by Django 3.1.8 on 2022-02-18 17:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(editable=False, max_length=300, unique=True)),
                ('email', models.EmailField(max_length=150, verbose_name='email address')),
                ('full_name', models.CharField(max_length=150)),
                ('gaards_number', models.CharField(blank=True, max_length=150, null=True)),
